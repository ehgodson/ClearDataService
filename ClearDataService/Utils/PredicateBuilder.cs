...
public class PredicateBuilder<T>
{
    ...
    /// </summary>
    public static PredicateBuilder<T> New(Expression<Func<T, bool>> predicate) => new(predicate);
    ...
    private PredicateBuilder(Expression<Func<T, bool>> predicate)
    {
    ...
    public PredicateBuilder<T> And(bool condition, Expression<Func<T, bool>> predicate)
    {
        if (condition)
        {
    ...
    /// <param name="condition">If true, the predicate will be added</param>
    /// <param name="predicate">The predicate to add if condition is true</param>
    public PredicateBuilder<T> Or(bool condition, Expression<Func<T, bool>> predicate)
    {
        if (condition)
        {
    ...
    /// <summary>
    /// Always adds a predicate using AND logic (unconditional)
    /// </summary>
    ...
    /// <summary>
    /// Always adds a predicate using OR logic (unconditional)
    /// </summary>
